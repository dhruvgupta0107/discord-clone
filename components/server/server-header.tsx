    ...
    return(
        <DropdownMenu>
            <DropdownMenuTrigger 
             ...
             >
                <button
                className="w-full text-md font-semibold px-2 flex items-center h-12
            ...
            >
                {isModerator && (
                    ...
                    className="text-indigo-600 dark:text-indigo-400 px-3 py-2 text-sm ml-auto"
                    >
                        Invite people
                ...
                {isAdmin && (
                    ...
                    className=" text-rose-500 px-3 py-2 text-sm ml-auto"
                    >
                        Delete server
